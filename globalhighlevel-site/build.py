...
LOCALIZED_LANDING_LANGS = [
    ...
    },
    {
        ...
        "desc": "ابدأ تجربتك المجانية لمدة 30 يوماً مع GoHighLevel. يلزم بطاقة للتحقق فقط (حجز مؤقت بقيمة دولار واحد تقريباً يُلغى تلقائياً، بدون رسوم اشتراك). وصول كامل لجميع الميزات. ألغِ في أي وقت.",
        "h1": "ابدأ تجربتك المجانية لمدة 30 يوماً مع GoHighLevel",
        "subh": "0$ لمدة 30 يوماً — فقط تحقق من البطاقة بقيمة ~1$. وصول كامل. ألغِ متى شئت.",
        ...
        "faq": [
            ("هل أحتاج إلى بطاقة ائتمان؟", "نعم. لتفعيل التجربة المجانية يلزم بطاقة — إنه تحقق بقيمة ~1$ يلغيه البنك تلقائياً، وليس رسم اشتراك. لا تدفع شيئاً خلال 30 يوماً ويمكنك الإلغاء في أي وقت."),
