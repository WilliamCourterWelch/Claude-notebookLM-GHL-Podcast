---
type: draft
slug: gohighlevel-ai-studio-pricing
built: 2026-07-29
---
...
|---|---|
| Pay-Per-Use ($0/mo) | Billed at token cost |
| Growth ($50/mo) | Usage included |
| Unlimited ($97/mo) | 3× usage included |

Two time-sensitive notes from the same doc: Ask AI is free through Summer 2026 as part of GoHighLevel's "Summer of AI" promotion, and — as with every rate on this page — GoHighLevel changes these terms, so check the [live doc](https://help.gohighlevel.com/support/solutions/articles/155000006652-ai-product-pricing) before budgeting.

## How much does GoHighLevel AI cost in total?

If you're pricing "the AI" as a whole, the honest stack as of July 2026 is:

1. **A GoHighLevel plan** — [$97, $297, or $497 per month](https://help.gohighlevel.com/support/solutions/articles/155000001156-highlevel-pricing-guide).
2. **An AI Employee tier** — [$0 (pay-per-use), $50 (Growth), or $97 (Unlimited) per month per location](https://help.gohighlevel.com/support/solutions/articles/155000006652-ai-product-pricing), which is where AI Studio usage comes from. The tier-by-tier detail is on the [AI Employee pricing page](/blog/gohighlevel-ai-employee-pricing/).
3. **Usage that's never bundled** — [Agent Studio (pay-per-use on all plans)](https://help.gohighlevel.com/support/solutions/articles/155000006652-ai-product-pricing) and phone-system charges on every call. Voice-minute economics live on the [Voice AI pricing page](/blog/gohighlevel-voice-ai-pricing/).

Some AI features cost nothing extra at all: Funnel & Website AI is free at 1,000 prompts/day per location, and Workflow AI is included subject to fair use (its premium actions bill at [$0.01 per execution](https://help.gohighlevel.com/support/solutions/articles/155000006652-ai-product-pricing)).

## AI Studio vs Agent Studio: which one are you paying for?
...
> ## **Try the whole AI suite on one trial**
...
> 30 days of full access — enough to see whether the bundled AI replaces your standalone tools.

## Frequently asked questions

#### How much does GoHighLevel AI cost?

As of July 2026: an AI Employee tier at $0 (pay-per-use), $50/month (Growth), or $97/month (Unlimited) per location, on top of a GoHighLevel plan at $97–$497/month. AI Studio usage is included with Growth and tripled on Unlimited; Agent Studio and phone charges always bill separately.

#### Is AI Studio free in GoHighLevel?

Its usage is included if you're on AI Employee Growth or Unlimited; on Pay-Per-Use it bills at token cost. Ask AI is free through Summer 2026 under GoHighLevel's promotion.

#### What's the difference between AI Studio and Agent Studio pricing?

AI Studio usage is bundled with the AI Employee tiers. Agent Studio — the custom agent builder — is never bundled: it's pay-per-use on every plan, billed by model tokens.

#### Do I need the $97 plan to use AI Studio?

No — Growth at $50/month includes AI Studio usage, and Pay-Per-Use works with no monthly fee at token cost. The $97 Unlimited tier triples the included usage and lifts the voice/chat caps.
